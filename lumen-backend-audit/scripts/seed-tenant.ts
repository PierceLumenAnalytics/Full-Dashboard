...
async function main() {
  try {
    ...
    // 3. Create Demo Agency login (agency@lumen.co / [REDACTED])
    await setupUser("agency@lumen.co", "[REDACTED]", false, demoAgency.id);

    // 4. Create Lumen Admin login (admin@lumen.co / [REDACTED])
    await setupUser("admin@lumen.co", "[REDACTED]", true, null);
